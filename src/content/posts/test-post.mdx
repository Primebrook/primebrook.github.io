...
<div class="callout">
  <strong>This is a test post.</strong> It exists to check what this blog can render:
  LaTeX from beyond the basics, algorithms, diagrams and an animated figure. It isn't an
  article and will be deleted once the real posts start.
</div>
